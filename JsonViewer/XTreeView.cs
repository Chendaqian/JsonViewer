...
namespace Json.Viewer
{
    ...
    public sealed partial class XTreeView : TreeView
    {
        ...
        protected override void OnDrawNode(DrawTreeNodeEventArgs e)
        {
            ...
            if (e.Bounds == Rectangle.Empty) return;

            e.Graphics.CompositingQuality = CompositingQuality.HighQuality;
            e.Graphics.SmoothingMode = SmoothingMode.AntiAlias;
            e.Graphics.PixelOffsetMode = PixelOffsetMode.HighQuality;

            Brush brsBack = new SolidBrush(BackColor);
            Brush brsFore = new SolidBrush(ForeColor);
            Pen penFore = new Pen(ForeColor);
            Brush brsSelectedBack = new SolidBrush(Focused ? _selectedBackColorFocused : _selectedBackColorUnFocused);
            Brush brsSelectedFore = new SolidBrush(Focused ? _selectedForeColorFocused : _selectedForeColorUnFocused);
            Pen penSelectedFore = new Pen(Focused ? _selectedForeColorFocused : _selectedForeColorUnFocused);
            ...
            e.Graphics.DrawIconUnstretched(
                e.Node.IsExpanded ?
                    Resources.tree_collapse :
                    Resources.tree_expand,
                new Rectangle(x, y, Resources.tree_expand.Width, Resources.tree_expand.Height));
            ...
            brsFore.Dispose();
            penFore.Dispose();
            brsSelectedBack.Dispose();
            brsSelectedFore.Dispose();
            penSelectedFore.Dispose();
        }
